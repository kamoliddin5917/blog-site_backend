...
var default_1 = /** @class */ (function () {
    ...
    default_1.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, $or, user, compare, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, User_1.default.findOne({ $or: $or })];
                    case 1:
                        user = _a.sent();
                        if (!user)
                            return [2 /*return*/, res.status(400).json({ message: "Bad request!" })];
                        return [4 /*yield*/, bcrypt_1.default.comparePassword(data.password, user.password)];
                    case 2:
                        compare = _a.sent();
                        if (!compare)
                            return [2 /*return*/, res.status(400).json({ message: "Bad request!" })];
