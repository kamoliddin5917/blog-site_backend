...
var default_1 = /** @class */ (function () {
    ...
    default_1.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, token, id, comment, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!mongoose_1.default.Types.ObjectId.isValid(data.post))
                            return [2 /*return*/, res.status(400).json({ message: "Bad request!" })];
                        return [4 /*yield*/, Comment_1.default.create(__assign(__assign({}, data), { author: id.userId }))];
                    case 1:
                        comment = _a.sent();
                        if (!comment)
    ...
    default_1.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var data, commentId, token, id, updateComment, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        if (!mongoose_1.default.Types.ObjectId.isValid(commentId))
                            return [2 /*return*/, res.status(400).json({ message: "Bad request!" })];
                        return [4 /*yield*/, Comment_1.default.findOneAndUpdate({ _id: commentId, author: id.userId }, { $set: data })];
                    case 1:
                        updateComment = _a.sent();
                        if (!updateComment)
                            return [2 /*return*/, res.status(500).json({ message: "Server Update Error!" })];
                        res.status(200).json({ message: "Comment Update!", updateComment: updateComment });
                        return [3 /*break*/, 3];
                    case 2:
                        error_2 = _a.sent();
                        res.status(500).json({ message: "Server Error!" });
    ...
    default_1.prototype.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var commentId, token, id, deleteComment, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        if (!mongoose_1.default.Types.ObjectId.isValid(commentId))
                            return [2 /*return*/, res.status(400).json({ message: "Bad request!" })];
                        return [4 /*yield*/, Comment_1.default.findOneAndDelete().and([
                                { author: id.userId },
                                { _id: commentId },
                            ])];
                    case 1:
                        deleteComment = _a.sent();
                        if (!deleteComment)
                            return [2 /*return*/, res.status(500).json({ message: "Server Deleted Error!" })];
                        res.status(200).json({ message: "Comment Deleted!", deleteComment: deleteComment });
                        return [3 /*break*/, 3];
                    case 2:
                        error_3 = _a.sent();
                        res.status(500).json({ message: "Server Error!" });
